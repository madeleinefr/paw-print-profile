...
This creates the DynamoDB table and populates it with test data including user accounts, pets with medical records, clinics, pet images, and generated missing pet flyers.
